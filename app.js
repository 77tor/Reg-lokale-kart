...
// Sjekk om knappen faktisk er aktiv før vi kjører tung datahenting
    ...
    try { 
        ...
        // --- NY DEL: HENT SNITT FOR PRØVEN (ALLE ÅR) ---
        ...
        oppgaveSummerProeven.forEach(s => {
            htmlSide1 += `<td>${antallEleverProeven > 0 ? (s / antallEleverProeven).toFixed(1) : "0.0"}</td>`;
        });
        htmlSide1 += `<td class="col-sum">${antallEleverProeven > 0 ? (totalSumProeven / antallEleverProeven).toFixed(1) : "0.0"}</td></tr>`;
