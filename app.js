...
window.visBokModal = function(tema, aktueltTrinn, sesong) {
    ...
    if (!modal) {
        ...
        modal.style = "position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.7); display:flex; align-items:center; justify-content:center; z-index:2000000; font-family:sans-serif; backdrop-filter: blur(3px);";
